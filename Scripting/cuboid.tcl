# cuboid.tcl
# Cuboid commands are useful! I'm too lazy to write docs right now.
...
namespace eval cuboid {
	...
	proc init {} {
		if {[lsearch [info globals] haveLibSpacecraft] == -1} {
			error "Cuboid requires libSpacecraft!"
			return
		}
		createChatCommand "cuboid" Builder "Define a cuboid" cuboid::cuboid
		onPlayerChangeBlock cuboid::cuboidSetBlock
		scLog "Cuboid initialized."
	}
}
