...
h1. Guest Commands
* / - Get general help, a list of commands, or help on a specific command
...
* /teleport - tp_add [name] [x] [y] [z] [heading]: Adds a teleport leading from current position to the given position.
* /tp - tp_add [name] [x] [y] [z] [heading]: Adds a teleport leading from current position to the given position.
* /tp_add - tp_add [name] [x] [y] [z] [heading]: Adds a teleport leading from current position to the given position.
* /tp_remove - tp_remove [name]: Remove the named teleporter.
